...
const routes = [
  ...
  },
  {
    path: '/datalawa/inout',
    name: 'InOutListView',
    component: () => import(/* webpackChunkName: "datalawa", webpackPrefetch:true */ '../views/datalawa/InOutListView.vue')
  },
  {
    path: '/datalawa/inoutcard',
    name: 'InOutCardView',
    component: () => import(/* webpackChunkName: "datalawa", webpackPrefetch:true */ '../views/datalawa/InOutCardView.vue')
  },
  {
    path: '/datalawa/mycar',
    name: 'MyCarView',
    component: () => import(/* webpackChunkName: "datalawa", webpackPrefetch:true */ '../views/datalawa/MyCarView.vue')
  },
  {
